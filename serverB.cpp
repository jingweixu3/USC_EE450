...
int main(){
    ...
    if (bind(sockfd, (struct sockaddr*)&serverAddr, sizeof(serverAddr))){
        cout << "[-] <" << UDP_SERVER_B << ">Error in binding." << endl;
		return -1;
    }

    cout << "[+] Server B is up and running on the port <" << UDP_SERVER_B << ">" << endl << endl;
    ...
    while (1) {
        ...
        cout<< endl << "----------------------------------------------------" << endl;
        cout << "[+]<" << UDP_SERVER_B <<"> Receiving from <" << inet_ntoa(clientAddr.sin_addr) << ": " << ntohs(clientAddr.sin_port) 	
			 << ">: " << message << endl;
        ...
        cout << "[+]<" << UDP_SERVER_B <<"> Sending to <" << inet_ntoa(clientAddr.sin_addr) << ": " << ntohs(clientAddr.sin_port) 	
			 << ">: " << message << endl;
    }
